...
public class CreateCarsHeavyTraffic : MonoBehaviour
{
    ...
    {
        CreateCarsHeavyTraffic.a = a;
        densityX = a[0];
        densityZ = a[1];
        CreateCarsHeavyTraffic.x = CreateCarsHeavyTraffic.z = 0;
